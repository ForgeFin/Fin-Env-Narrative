...
def create_model(loadweight=None):
    ...
    preds = Dense(1, activation='sigmoid',name='output')(embedded_sequences)  # NOTE: SIGMOID FOR 2-CLASS PROBLEM; softmax for multiclass problem\n",
...
def create_model(loadweight=None):
    ...
    combined = Concatenate()([embedded_sequences, market_cap, industry])
...
def create_model(loadweight=None):
    ...
    combined = Concatenate()([embedded_sequences, env_perf])
